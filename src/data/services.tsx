...
export const services = [
  ...
  },
  {
    ...
    description: "Connect AI models directly into your existing software infrastructure, databases, and APIs. We build custom RAG pipelines, semantic search engines, and fine-tuned logic layers.",
    features: ["API & Model Plumbing", "Advanced RAG Pipelines", "Semantic & Vector Search", "Custom Data Workflows"],
    featureDescriptions: [
