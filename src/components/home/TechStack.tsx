...
const TechStack = () => {
  ...
  return (
    <section id="tech-stack" className="py-24 bg-[#f8fafc] relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        >
          {technologies.map((tech, index) => (
            ...
            >
              ...
              >
                <div className={`absolute inset-0 ${tech.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl`} />
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-[#1e40af] tracking-tight group-hover:text-[#1e40af]/90 transition-colors duration-300">
                      {tech.category}
                    </h3>
                  </motion.div>
        ...
        >
          <motion.div
            ...
            className="bg-[#3b82f6] p-12 rounded-3xl text-white shadow-2xl relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-[#3b82f6] bg-[size:40px_40px] opacity-30" />
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <motion.p
                ...
                className="text-[#93c5fd] text-lg leading-relaxed mb-8"
              >
              ...
              >
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-block px-10 py-4 bg-white text-[#3b82f6] font-bold rounded-2xl hover:bg-[#f8fafc] transition-all duration-300 shadow-xl hover:shadow-2xl"
                >
                  Start Your Project
                </motion.a>
              </motion.div>
